...
class _MyHomePageState extends State<CampaignDetails2>
  ...
  Widget build(BuildContext context) {
      ...
      tabList.add(
          ...
          Stack(
            children: <Widget>[
              ...
              IconButton(icon: Icon(   MaterialCommunityIcons
                  .instagram,
                size: 26,
              ),
                color: Colors.pink,
    ...
    if (widget.data["isYoutube"] == 1) {
      tabList.add(IconButton(icon: Icon(   MaterialCommunityIcons
          .youtube,
        size: 26,
        color: Colors.red,),
          ...
          children: <Widget>[
            ListView(
              ...
              children: <Widget>[
                ...
                widget.data['insta_tags'].trim() != ""? Container(
                  padding: const EdgeInsets.only(left: 24.0, right: 24.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("Tags to be used", style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16)),
                ...
                widget.data['insta_hash_tags'].trim() == ""?Container():    Container(
                  padding: const EdgeInsets.only(left: 24.0, right: 24.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("Hashtags to be used", style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16)),
                ...
                widget.data["insta_min_followers"] !=0 ?  Container(

                  padding: const EdgeInsets.only(left: 24.0, right: 24.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("Minimum followers", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
                ...
                widget.data["insta_something_else"] !=null ? widget.data["insta_something_else"].trim() !="" ? widget.data["insta_something_else"].toLowerCase() != "no" &&

                    widget.data["insta_something_else"].toLowerCase() != "null"?
                Container(
                  padding: const EdgeInsets.only(left: 24.0, right: 24.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text("Image to be posted", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
                ...
                Padding(
                  child:                 Text("Reference Image", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
            ...
            Positioned(bottom: 30, child: Padding(child: Container(
              ...
              child: FlatButton(
                ...
                child: Text("Place a bid", style: TextStyle(color: Colors.white, fontSize: 18),), color: LocalColors.secondaryColor, onPressed: (){
          ...
          children: <Widget>[
            ListView(
              ...
              children: <Widget>[
                ...
                widget.data['fb_tags'].trim() != "" ?Container(
                  padding: const EdgeInsets.only(left: 24.0, right: 24.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                ...
                widget.data['fb_hash_tags'].trim() != "" ?Container(
                  padding: const EdgeInsets.only(left: 24.0, right: 24.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                ...
                widget.data["fb_min_likes"] !=0 ?  Container(

                  padding: const EdgeInsets.only(left: 24.0, right: 24.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("Minimum likes", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
                ...
                widget.data["fb_something_else"] !=null ? widget.data["fb_something_else"].trim() !="" ? widget.data["insta_something_else"].toLowerCase() != "no" &&

                    widget.data["fb_something_else"].toLowerCase() != "null"?
                Container(
                  padding: const EdgeInsets.only(left: 24.0, right: 24.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                ...
                widget.data["fb_your_post"].trim() == ""?Container():     Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Container(
                      padding: const EdgeInsets.only(left: 24.0, right: 24.0),
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text("Reference Image", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
           ...
           widget.data["fb_reference"].trim() == ""?Container():     Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Container(
                      padding: const EdgeInsets.only(left: 24.0, right: 24.0),
          ...
          children: <Widget>[
            ListView(
              ...
              children: <Widget>[
                ...
                widget.data['yt_hash_tags'].trim() == ""?Container():    Container(
                  padding: const EdgeInsets.only(left: 24.0, right: 24.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                ...
                widget.data["yt_min_subs"] !=0 ?  Container(

                  padding: const EdgeInsets.only(left: 24.0, right: 24.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("Minimum Subscribers", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
                ...
                widget.data["yt_something_else"] !=null ? widget.data["yt_something_else"].trim() !="" ? widget.data["yt_something_else"].toLowerCase() != "no" &&

                    widget.data["yt_something_else"].toLowerCase() != "null"?
                Container(
                  padding: const EdgeInsets.only(left: 24.0, right: 24.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text("Youtube Reference", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
